...
**As a developer.** Check out the [API documentation](/api) to begin integrating

**As an end-user.** Check out the available front-ends that use Gyre, and the [install
page](/docs/install/gyre-installer) for how to use Gyre locally
